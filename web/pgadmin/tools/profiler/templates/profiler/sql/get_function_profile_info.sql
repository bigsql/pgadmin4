...
SELECT
    ...
    l.lanname,          -- language name
    p.proretset,        -- procedure return set
    p.prorettype,       -- procedure return type
    y.typname AS rettype,  -- pg_catalog return type
    CASE WHEN proallargtypes IS NOT NULL THEN -- when the selected procedure has arguments
